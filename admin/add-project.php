...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        ...
        $stmt = $conn->prepare("INSERT INTO projects (title, description, image, tech_stack, category, demo_link) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssss", $title, $description, $image_path, $tech_stack, $category, $demo_link);
...
<head>
    ...
    <title>Add Project - Varelis Architects</title>
                ...
                <div class="form-container">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="tech_stack" placeholder="e.g., Modern Design, 3D Visualization, Sustainable">
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Demo Link (optional)</label>
                            <input type="url" class="form-control" name="demo_link" placeholder="https://example.com">
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Project Image</label>
                            <input type="file" class="form-control" name="image" accept="image/*" required>
                            <small class="text-muted">Accepted formats: JPG, JPEG, PNG, GIF, WEBP</small>
                        </div>
